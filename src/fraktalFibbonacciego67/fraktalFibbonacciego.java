...
public class fraktalFibbonacciego {
	public static void main(String[] args) {
		...
		List<String> bianryFibbonacci = new ArrayList<>();
		...
		/* 67.3
		 * for(int i = 0; i< 39; i++) { System.out.println(bianryFibbonacci.get(i)); }
		 */
	...
	/* 67.2
	 * private static List<Integer> getPrimeElements(List<Integer> fibbonacci) {
